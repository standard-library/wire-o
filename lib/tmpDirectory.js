...
/**
 * Returns promise to create uniquely-named directory within the Lambda
 * server's /tmp directory. This way, if the Lambda server gets reused in
 * running the function, then there won't be any existing files in this
 * uniqely-named directory to address.
