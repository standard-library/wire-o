...
/**
 * Returns request to upload the merged PDF to S3 and send its (unformatted) location
 ...
 * @returns {Function} - Function that uploads the merged PDF to S3 and returns the location URL, uploadToS3~async
 * @example
